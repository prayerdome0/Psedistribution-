...
(function () {
    ...
    var DEFAULT_HOLIDAYS = [
        { key: 'new-year', name: "New Year's Day", emoji: '🎆', colors: ['#0b2138', '#0e7c68'], accent: '#e0a62e',
        ...
        { key: 'eid', name: 'Eid al-Fitr', emoji: '🌙', colors: ['#0e4d38', '#0e7c68'], accent: '#e0a62e', approx: true,
        ...
        { key: 'summer-sale', name: 'Summer Wholesale Fest', emoji: '☀️', colors: ['#9a7d0a', '#e0a62e'], accent: '#fff9c4',
        ...
        { key: 'halloween', name: 'Halloween', emoji: '🎃', colors: ['#1c0e2e', '#e0a62e'], accent: '#f5b041',
        ...
        { key: 'diwali', name: 'Diwali — Festival of Lights', emoji: '🪔', colors: ['#4a235a', '#e0a62e'], accent: '#fdedec', approx: true,
        ...
        { key: 'black-friday', name: 'Black Friday', emoji: '🛍️', colors: ['#000000', '#2c3e50'], accent: '#e0a62e',
    ...
    function normalize(h, year) {
        ...
        return {
            ...
            name: h.name,
            emoji: h.emoji || '🎉',
            colors: h.colors || ['#0b2138', '#0e7c68'],
            accent: h.accent || '#e0a62e',
        ...
        try {
            ...
            snap.forEach(function (doc) {
                ...
                customHolidays.push({
                    ...
                    name: d.name,
                    emoji: d.emoji || '🎉',
                    colors: d.colors || ['#0b2138', '#0e7c68'],
                    accent: d.accent || '#e0a62e',
                    message: d.message || '',
                    cta: d.cta || 'Shop Now',
                    url: d.url || '',
                    approx: true,
    ...
    async function addCustomHoliday(data) {
        ...
        var record = {
            ...
            colors: data.colors || ['#0b2138', '#0e7c68'],
            accent: data.accent || '#e0a62e',
