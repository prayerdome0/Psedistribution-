...
from .runtime_core import load_publisher_module
...
class SnapshotRepository:
    def __init__(
        ...
        *,
        ...
        self.packet_root = packet_root or Path(__file__).resolve().parents[2]
        self.clock = clock
        self._publisher = load_publisher_module(self.packet_root)
